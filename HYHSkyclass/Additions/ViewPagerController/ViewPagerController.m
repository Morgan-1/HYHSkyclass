...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    // SCREEN_WIDTH => kScreenWidth
    if (self.currentIndex == 0 && scrollView.contentOffset.x < kScreenWidth && self.canLimitBounce == YES) {
        scrollView.contentOffset = CGPointMake(kScreenWidth, scrollView.contentOffset.y);
    } else if (self.currentIndex == (self.tabCount - 1) && scrollView.contentOffset.x > kScreenWidth && self.canLimitBounce == YES) {
        scrollView.contentOffset = CGPointMake(kScreenWidth, scrollView.contentOffset.y);
    }
}
